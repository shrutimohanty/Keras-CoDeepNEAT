...
def run_mnist_full(generations, training_epochs, population_size, blueprint_population_size, module_population_size, n_blueprint_species, n_module_species, final_model_training_epochs, thread_num):
    ...
    print("init time: ", init_time_len)
    print("data init time: ", data_process_time_len)
    print("model init time: ", model_init_time_len)
    print("main training time: ", main_time_len)
...
if __name__ == "__main__":
    ...
    run_mnist_full(generations, training_epochs, population_size, blueprint_population_size, module_population_size, n_blueprint_species, n_module_species, final_model_training_epochs, thread_num)
